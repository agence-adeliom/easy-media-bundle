    ...
    methods: {
        ...
        dbltap(e) {
            ...
            if (!this.isBulkSelecting()) {
                ...
                // media
                else if ((this.selectedFileIs('video') || this.selectedFileIs('audio')) && !this.inModal) {
                    return !(this.player && this.player.playing) ? this.toggleModal('preview_modal') : null;
                }
                // folder
                ...
                // other
                    ...
                    EventHub.fire('file_modal_selected', this.selectedFile)
                }else{
