            ...
            ->arrayNode('default_sort')
                ...
                ->children()
                    ->scalarNode('field')
                        ->defaultValue('id')
                        ->validate()
                            ->ifNotInArray(['id', 'name', 'size', 'lastModified'])
                            ->thenInvalid('Invalid default_sort.field "%s". Allowed values: id, name, size, lastModified')
                        ->end()
                    ->end()
                    ->scalarNode('order')
                        ->defaultValue('ASC')
                        ->validate()
                            ...
                            ->thenInvalid('Invalid default_sort.order "%s". Allowed values: ASC, DESC')
                        ->end()
                    ->end()
                ->end()
            ->end()
